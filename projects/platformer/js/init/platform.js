(function (window) {
    ...
    platform.init = function (game) {
        ...
        platform.create(500,500,1,.5);
        
        platform.create(230,400,.5,.5);
        
        platform.create(10,3);
        
        
        platform.create(230,400,.5,.5);
        
        platform.create(230,300,30,.2);
        
        platform.create(550,100,1,.5);
        
        platform.create(500,120,1,.5);
